...
public class CategoriesReader {
    ...
    public static CategoriesModel[] readAllCategories(){
        CategoriesModel[] res = new CategoriesModel[83];
        int i=0;
        res[i++] = new CategoriesModel("家庭", "jiā tíng", "Family", "Семья");
        res[i++] = new CategoriesModel("银行", "jyín háng", "Bank", "Банк");
        res[i++] = new CategoriesModel("面部", "jmiàn bù", "Face", "Лицо");
        ...
        res[i++] = new CategoriesModel("?", "?", "Colors", "Цвета");
        res[i++] = new CategoriesModel("?", "?", "Sides", "Стороны");
        ...
        res[i++] = new CategoriesModel("周末", "zhōu mò", "Weekend", "Выходные");
        ...
        res[i++] = new CategoriesModel("开车", "kāi chē", "Drive car", "Водить машину");
